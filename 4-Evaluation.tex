...
We compare \snaOpt against \sna and \snaTerm to evaluate the 
effect of combining termination and nontermination analysis.
...
The evaluation focuses on termination analysis of Integer Transition Systems. 
...
We excluded 42 trivially terminating benchmarks from the evaluation (terminate syntactically), which
are solved by all tools.
The evaluation was executed with 120 seconds timeout (increase of the timeout does not 
...
Table~\ref{tab:internal} presents the experimental results for \snaOpt, \sna, and \snaTerm. 
...
We attribute this to \snaOpt generation of focused sub-problems, 
...
The best results are obtained with TPA, solving 761 instances. 
\snaOpt with PDR solves fewer instances (756), however it can solve 17 benchmarks uniquely compared to the TPA.
%
...
state-of-the-art termination analysers, where each axis represents the solving time in seconds for a given tool.
...
\snaOpt solves 761 benchmarks, with \Tt solving 1002, \KoAT 562, and \LoAT 525 instances.
...
instances previously unsolved by any tool in the Termination Competition.
