...
For SMT queries and interpolant construction, our implementation uses the \opensmt SMT solver~\cite{DBLP:conf/sat/HyvarinenMAS16,DBLP:conf/tacas/BruttomessoPST10}.
...
We compared \snaOpt against \sna and \snaTerm to evaluate the 
...
and nonterminating instances, solving 240 instances not solved by neither \sna nor \snaTerm. 
...
The best results were obtained with the TPA safety checks, solving 761 instances. 
\snaOpt with PDR solved fewer instances (756), however it could solve 17 benchmarks uniquely compared to the TPA-based algorithm.
%

\begin{figure*}[t!]
    \centering
    \includegraphics[width=0.92\linewidth]{Figures/scatterSt.pdf}
...
As shown in Figure~\ref{fig:stateOfArtComp}, \snaOpt, despite being a prototype implementation, is competitive with state-of-the-art termination analysers.
...
19 previously unsolved instances in the Termination Competition, for which \snaOpt found recurrent sets thus leading to proving nontermination.
