...
% However, the intermediate results of these approaches can be utilised to guide one another.
The core idea of this paper is to connect termination and nontermination analysis,
enabling the two to share their intermediate results and guide one another.
