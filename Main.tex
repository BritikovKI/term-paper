...
However, these approaches may often share their intermediate results to guide one another.
We present a new approach for the interpolation-based 
...
The technique extends safety-based nontermination analysis, allowing it to prove both 
...
Empirical results demonstrate that combining termination and nontermination yields performance comparable to current state-of-the-art tools.
\end{abstract}
