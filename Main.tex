...
formal methods. Existing techniques are predominantly based on ranking function 
synthesis, which can be insufficient when the transition relation is too complex 
to admit a ranking function directly, even for terminating systems.
...
our approach guides transition invariant synthesis with respect to the conditions 
relevant to termination, enabling property-directed invariant generation that 
naturally handles complex transition relations. Our technique is integrated with 
safety-based nontermination analysis, allowing it to prove both termination and 
