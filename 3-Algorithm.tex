...
\begin{example}\label{Ex:Motivation}
    ...
    \begin{align*}
        ...
        Tr(x, x') &\triangleq ((v' = v - 1 \land u' = u ) \lor 
                     (v' = v + 1 \land u' = u + 1 \land u < 10)) \land v > 0
    \end{align*}
    ...
    $Inv(x) \equiv v \neq 0$. 
    Since $v = 1 \land u = 10$ has no  outgoing transition under the refined $Tr'$ (the decrementing 
    branch would produce $v' = 0$, which is now blocked), $Inv$ is not a recurrent set. 
